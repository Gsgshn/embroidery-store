        ...
        <div className=" flex justify-between mt-2  md:hidden">
            <div className=" flex flex-col w-full ">
                <div className="flex justify-between items-center mx-5">
                    ...
                    <Link href='/cart' className="w-10 mt-3"><ShoppingCartIcon /></Link>
                </div>
                
                <div className={`flex flex-col  items-start fixed bg-neutral-900  w-screen h-full bottom-0 left-0 top-0 right-0 z-50 inset-0 ${isOpen? "" : "hidden"}`}>
